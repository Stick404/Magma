package test.learn.TL.Functions;

import test.learn.TL.Core.TLFunction;
import test.learn.TL.Functions.BaseFunctions.*;
import test.learn.TL.Functions.BaseFunctions.Eval.FunEval;
import test.learn.TL.Functions.BaseFunctions.Eval.FunMap;
import test.learn.TL.Functions.BaseFunctions.Eval.FunParse;
import test.learn.TL.Functions.BaseFunctions.List.*;
