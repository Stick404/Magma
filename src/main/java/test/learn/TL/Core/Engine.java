...
import static test.learn.TL.Functions.TLFunctionRegistry.FUNCS;
...
public class Engine {
    ...
    public TLExpression apply(TLFunction function, TLListExpression arguments, TLEnvironment environment) throws Exception {
        return function.invoke(arguments, environment);
    }
